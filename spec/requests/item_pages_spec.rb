  ...
  describe 'create a new item' do
    ...
    describe 'with valid information' do
      before do
        ...
        fill_in 'Tell us more about what you have - how much, ?',
                with: 'I have lots of Kale. Come get some.'
        fill_in 'Where are you at? ex. 1st and Main',
                with: '17th and Pettygrove Portland Oregon'
        fill_in 'Contact me by email (add it here)',
